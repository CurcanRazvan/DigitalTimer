...
This is the project I built for my 2nd-year university practice module. It is a digital timer designed in KiCad that can count both up and down (0-99), displaying the numbers on two 7-segment displays.

![3D Render](img/pcb_3d1.png)

### Technical Overview

The circuit is designed with a modular approach, featuring the following stages:
1.  **Clock Signal:** Generated by an **NE555** timer configured as an astable oscillator.
2.  **Counting:** Handled by two **74LS193** 4-bit synchronous binary counters (U7 and U8). These allow counting in both directions (UP/DOWN).
3.  **Decoding & Display:** The binary signal is converted for the 7-segment displays using **CD4511** decoders (U6 and U10).

**Other logic components used:**
* **74LS73 (U2):** JK Flip-flop for control.
* **74LS08 (U3):** AND gates.
* **CD4071 (U4):** OR gates.
...
* With these changes, the circuit works perfectly according to specs.
